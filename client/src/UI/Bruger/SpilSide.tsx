...
export default function SpilSide({ className = "" }: ClickableGridUIProps) {
    ...
    const { isRepeatChecked, setRepeat } = useRepeat(false);
    ...
    const handlePayment = async () => {
        ...
        if (!isGameAvailable) {
            alert("Spillet er desværre lukket for denne uge.");
            return;
        }

        const success = await buyPlade(currentUser.userId, isRepeatChecked);
        ...
        <img src={Logo} alt="Logo" onClick={() => navigate("/forside")} />
            ...
            <div className="main-container">
                ...
                <div className="background-spilside">
                    ...
                    <div>
            <span className="text-uge">
              Nuværende spil: Uge {currentWeek} {currentYear}
            </span>
                    </div>
                    ...
                    <div
                        className={`cg-container ${className}`}
                        style={{
                            opacity: isGameAvailable ? 1 : 0.5,
                            pointerEvents: isGameAvailable ? 'auto' : 'none'
                        }}
                    >
                        <div
                            role="grid"
                    ...
                    <div>
                        ...
                        <button
                            ...
                            style={{
                                cursor: isGameAvailable ? 'pointer' : 'not-allowed',
                                backgroundColor: isGameAvailable ? '' : 'grey'
                            }}
                        >
